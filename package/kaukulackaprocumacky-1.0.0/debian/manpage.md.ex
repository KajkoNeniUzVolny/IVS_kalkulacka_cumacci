% kaukulackaprocumacky(SECTION) | User Commands
%
% "April 26 2023"
...
kaukulackaprocumacky - program to do something

# SYNOPSIS

**kaukulackaprocumacky** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**kaukulackaprocumacky** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **kaukulackaprocumacky** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**kaukulackaprocumacky** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    kaukulackaprocumacky. See **foo.conf**(5) for further details.
...
**kaukulackaprocumacky** provides some return codes, that can be used in scripts:
...
Pavol Sloboda <pavo.sloboda02@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Pavol Sloboda
